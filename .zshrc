...
gcm() {
    ...
    generate_commit_message() {
        git diff --cached | claude -p --model claude-haiku-4-5-20251001 --no-session-persistence "Generate a commit message for this diff. Use conventional commit format (feat:, fix:, docs:, refactor:, test:, chore:). Keep the first line under 72 characters. Be specific. Output only the commit message, no trailers or co-authored-by lines. Do not wrap the message in backticks or code blocks."
    }
